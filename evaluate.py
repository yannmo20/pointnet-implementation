...
parser.add_argument('--model_path', default='/media/moellya/yannick/training_sessions/ziszero_exactboundary_RANDnoObjCone_FAR/model.ckpt', help='model checkpoint file path [default: log/model.ckpt]')
