...
# TF1.2
# g++ -std=c++11 tf_grouping.cpp tf_grouping_g.cu.o -o tf_grouping_so.so -shared -fPIC -I /home/moellya/miniconda3/envs/tf12/lib/python3.6/site-packages/tensorflow/include -I /usr/local/cuda/include -lcudart -L /usr/local/cuda/lib64/ -O2 -D_GLIBCXX_USE_CXX11_ABI=0

# TF1.4
# g++ -std=c++11 tf_grouping.cpp tf_grouping_g.cu.o -o tf_grouping_so.so -shared -fPIC -I /home/moellya/miniconda3/envs/tf/lib/python3.6/site-packages/tensorflow/include -I /home/moellya/miniconda3/envs/tf/lib/python3.6/site-packages/tensorflow/include/external/nsync/public -I /home/moellya/miniconda3/envs/tf/lib/python3.6/site-packages/tensorflow/core -I /usr/local/cuda/include -lcudart -L /usr/local/cuda/lib64/ -L/home/moellya/miniconda3/envs/tf/lib/python3.6/site-packages/tensorflow/ -ltensorflow_framework -O2 -D_GLIBCXX_USE_CXX11_ABI=0
